...
Issues, reproducible examples, and non-code suggestions are welcome. Do not submit code or assets until the published
contributor agreement is available and you have signed it. Approval in an issue or discussion is not a substitute for
that signed agreement.

This temporary policy does not affect reports or discussions that contain no contributed source code or assets.
